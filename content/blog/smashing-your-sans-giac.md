...
### Carve time and manage expectations
The fast pace of these courses means that you shouldn't really waste time fiddling around.  This can be tricky with Security Operation-type roles, as we often need to context switch and "always be on".  I found that managing expectations with my manager and colleagues was a very valuable activity. 

----

### Create an index early
...
### Test your index during practice exams
...
### Use material outside of the course
You will find that some courses will continually reference information that requires a lookup.  For this, take note of any areas you may be a little bit iffy on and write them in a quick-reference "cheat sheet section".  I can recommend combing through [chrisjd20's blue team cheatsheet](https://github.com/chrisjd20/Blue-Team-Cheat-Sheets/).
...
* [How to build a SANS GIAC Index](https://www.ericooi.com/how-to-build-a-sans-giac-index/)
* [Better GIAC Testing with Pancakes](https://tisiphone.net/2015/08/18/giac-testing/)
* [Building a GIAC Index / Survival Traits](https://www.youtube.com/watch?v=U4QmSQDIiHM)
* [Making a GIAC Exam Index](https://br0nw3n.com/2018/10/making-a-giac-exam-index/)
* [What not to do when taking GIAC exams](http://montance.blogspot.com/2016/10/what-not-to-do-when-taking-giac-exam.html)